...
const ContactForm = () => {
  ...
  const pressHandler = async () => {
    ...
    await sendQuery({
      ...
      message,
      name
    }).then(res => res.json()).then(res => showToastWithGravity(res.message)).catch(error => showToastWithGravity(error.message));
    setName("");
    setEmail("");
    setMessage("");
    setMessageValidations("");
      ...
      <ScrollView>
        ...
        <View style={styles.ojYLSGus}>
          ...
          <View style={styles.pt14}>
            ...
            <View style={[styles.textInput, styles.PhBTcDpz]}>
