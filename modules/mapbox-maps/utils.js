...
export const renderPolygon = polygon => {
  return <MapboxGL.ShapeSource id="source" shape={polygon}>
      <MapboxGL.FillLayer id="fill" style={styles.rWMsmlno} />
      <MapboxGL.LineLayer id="line" style={styles.FhkdBGCx} />
    </MapboxGL.ShapeSource>;
};
export const renderDestinationAnnotations = (destination, destinationTitle, setDestinationTitle, handleGetOriginAddress) => {
  return <MapboxGL.MarkerView id={"marker2"} coordinate={destination}>
      <View>
...
export const renderMarkedArea = () => {
  return <MapboxGL.MarkerView id={"marker2"} coordinate={options.MARKED_CENTERED}>
      <View>
        <View style={styles.markerContainer}>
          <Image source={{
          uri: pinImgUri
